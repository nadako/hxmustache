// Generated by Haxe 3.3.0 (git build development @ 6eb9c9a)
...
AsyncTools.aForEachOfMapLimit = function(iterable,limit,cb,done) {
	...
	var completedItems = function() {
		...
		var _g = [];
		var _g2 = 0;
		while(_g2 < currentPos) _g.push(complete.h[_g2++]);
		return _g;
	};
	var next = null;
	next = function() {
...
var ContextTest = function() {
	...
	this.describe("A new Mustache.Context",buddy_TestFunc.Sync(function() {
		...
		_gthis.it("is able to lookup properties of its own view",tmp1);
		...
		_gthis.it("is able to lookup nested properties of its own view",tmp2);
		var tmp3 = buddy_TestFunc.Sync(function() {
			...
			_gthis.it("returns the child context",tmp5);
			...
			_gthis.it("is able to lookup properties of its own view",tmp6);
			...
			_gthis.it("is able to lookup properties of the parent context's view",tmp7);
			...
			_gthis.it("is able to lookup nested properties of its own view",tmp8);
			...
			_gthis.it("is able to lookup nested properties of its parent view",tmp9);
		});
		_gthis.describe("when pushed",tmp3);
	}));
};
...
var ParseTest = function() {
	...
	this.describe("Mustache.parse",buddy_TestFunc.Sync(function() {
		...
		while(tmp.hasNext()) {
			...
			var tmp1 = "knows how to parse " + JSON.stringify(template[0]);
			var tmp2 = buddy_TestFunc.Sync((function(template1) {
				return function() {
					utest_Assert.same(__map_reserved[template1[0]] != null?expectations.getReserved(template1[0]):expectations.h[template1[0]],Mustache.defaultWriter.parse(template1[0],null),null,null,null,{ fileName : "ParseTest.hx", lineNumber : 75, className : "ParseTest", methodName : "new"});
				};
			})(template));
			_gthis.it(tmp1,tmp2);
		}
		var tmp3 = buddy_TestFunc.Sync(function() {
			...
			_gthis.it("throws an error",tmp4);
		});
		_gthis.describe("when there is an unclosed tag",tmp3);
		var tmp5 = buddy_TestFunc.Sync(function() {
			var tmp6 = buddy_TestFunc.Sync(function() {
				ParseTest["throws"](function() {
			...
			_gthis.it("throws an error",tmp6);
		});
		_gthis.describe("when there is an unclosed section",tmp5);
		var tmp7 = buddy_TestFunc.Sync(function() {
			var tmp8 = buddy_TestFunc.Sync(function() {
				ParseTest["throws"](function() {
			...
			_gthis.it("throws an error",tmp8);
		});
		_gthis.describe("when there is an unopened section",tmp7);
		var tmp9 = buddy_TestFunc.Sync(function() {
			...
			_gthis.it("throws an error",tmp10);
		});
		_gthis.describe("when invalid tags are given as an argument",tmp9);
		var tmp11 = buddy_TestFunc.Sync(function() {
			...
			_gthis.it("throws an error",tmp12);
		});
		_gthis.describe("when the template contains invalid tags",tmp11);
	}));
};
...
var ScannerTest = function() {
	...
	this.describe("A new Mustache.Scanner",buddy_TestFunc.Sync(function() {
		var tmp = buddy_TestFunc.Sync(function() {
			...
			_gthis.it("is at the end",tmp1);
		});
		_gthis.describe("for an empty string",tmp);
		var tmp2 = buddy_TestFunc.Sync(function() {
			var scanner;
			...
			var tmp3 = buddy_TestFunc.Sync(function() {
				var tmp4 = buddy_TestFunc.Sync(function() {
					var tmp5 = buddy_TestFunc.Sync(function() {
						var match = scanner.scan(new EReg("a b c",""));
						utest_Assert.equals(scanner.string,match,null,{ fileName : "ScannerTest.hx", lineNumber : 25, className : "ScannerTest", methodName : "new"});
						utest_Assert.isTrue(scanner.tail == "",null,{ fileName : "ScannerTest.hx", lineNumber : 26, className : "ScannerTest", methodName : "new"});
					});
					_gthis.it("returns the entire string",tmp5);
				});
				_gthis.describe("when the RegExp matches the entire string",tmp4);
				var tmp6 = buddy_TestFunc.Sync(function() {
					var tmp7 = buddy_TestFunc.Sync(function() {
					...
					_gthis.it("returns the portion of the string that matched",tmp7);
				});
				_gthis.describe("when the RegExp matches at index 0",tmp6);
				var tmp8 = buddy_TestFunc.Sync(function() {
					var tmp9 = buddy_TestFunc.Sync(function() {
					...
					_gthis.it("returns the empty string",tmp9);
				});
				_gthis.describe("when the RegExp matches at some index other than 0",tmp8);
				var tmp10 = buddy_TestFunc.Sync(function() {
					var tmp11 = buddy_TestFunc.Sync(function() {
					...
					_gthis.it("returns the empty string",tmp11);
				});
				_gthis.describe("when the RegExp does not match",tmp10);
			});
			_gthis.describe("scan",tmp3);
			var tmp12 = buddy_TestFunc.Sync(function() {
				var tmp13 = buddy_TestFunc.Sync(function() {
					...
					_gthis.it("returns the empty string",tmp14);
				});
				_gthis.describe("when the RegExp matches at index 0",tmp13);
				var tmp15 = buddy_TestFunc.Sync(function() {
					...
					_gthis.it("returns the string up to that index",tmp16);
				});
				_gthis.describe("when the RegExp matches at some index other than 0",tmp15);
				var tmp17 = buddy_TestFunc.Sync(function() {
					var tmp18 = buddy_TestFunc.Sync(function() {
						var match1 = scanner.scanUntil(new EReg("z",""));
						utest_Assert.equals(scanner.string,match1,null,{ fileName : "ScannerTest.hx", lineNumber : 75, className : "ScannerTest", methodName : "new"});
						utest_Assert.isTrue(scanner.tail == "",null,{ fileName : "ScannerTest.hx", lineNumber : 76, className : "ScannerTest", methodName : "new"});
					});
					_gthis.it("returns the entire string",tmp18);
				});
				_gthis.describe("when the RegExp does not match",tmp17);
			});
			_gthis.describe("scanUntil",tmp12);
		});
		_gthis.describe("for a non-empty string",tmp2);
	}));
};
...
TestMain.main = function() {
	...
	var outputError = function() {
		...
		haxe_Log.trace(runner.unrecoverableError,{ fileName : "GenerateMain.hx", lineNumber : 202, className : "TestMain", methodName : "main"});
		...
		while(_g < stack.length) {
			...
			if(s[1] == 2) {
				...
				var file = s[3];
				if(line > 0) {
					haxe_Log.trace(file + ":" + line,{ fileName : "GenerateMain.hx", lineNumber : 208, className : "TestMain", methodName : "main"});
				}
			}
		}
	};
...
var TestSpec = function() {
	...
	this.describe("Mustache spec compliance",buddy_TestFunc.Sync(function() {
		...
		while(_g < _g1.length) {
			...
			++_g;
			var tmp1 = "- " + specArea[0] + ":";
			var tmp11 = buddy_TestFunc.Sync((function(specArea1) {
				return function() {
					var _g2 = 0;
					...
					while(_g2 < _g3.length) {
						...
						if(Object.prototype.hasOwnProperty.call(_gthis.skipTests,specArea1[0]) && _gthis.skipTests[specArea1[0]].indexOf(test[0].name) != -1) {
							...
							var tmp2 = buddy_TestFunc.Sync((function(test1) {
								return function() {
									var template = test1[0].template;
									var this1 = new mustache__$Context_ContextImpl(test1[0].data,null,null);
									...
									var output = _this.renderTokens(_this.parse(template),this1,partials,template);
									utest_Assert.equals(test1[0].expected,output,null,{ fileName : "TestSpec.hx", lineNumber : 71, className : "TestSpec", methodName : "new"});
								};
							})(test));
							_gthis.it(desc,tmp2);
						}
...
var buddy_ShouldInt64 = function() { };
...
var buddy_SuitesRunner = function(buddySuites,reporter) {
	...
	this.includeMode = Object.prototype.hasOwnProperty.call(haxe_rtti_Meta.getType(buddy_BuddySuite),"includeMode");
};
...
buddy_SuitesRunner.prototype = {
	...
	,runDescribes: function(cb) {
		...
		var processSuiteDescribes = function(suite) {
			while(!Lambda.empty(suite.describeQueue)) {
				...
				switch(_g[1]) {
				case 0:
					asyncQueue.push({ buddySuite : suite, testSuite : current.suite, run : _g[2]});
					break;
				case 1:
					syncQueue.push({ buddySuite : suite, testSuite : current.suite, run : _g[2]});
					break;
				}
			}
		};
		...
		processBuddySuites = function() {
			var tmp = $iterator(_gthis.buddySuites)();
			while(tmp.hasNext()) {
				var buddySuite = tmp.next();
				processSuiteDescribes(buddySuite);
			}
	...
	,startIncludeMode: function() {
		...
		this.buddySuites = Lambda.filter(this.buddySuites,function(buddySuite) {
			var tmp = buddySuite == null?null:js_Boot.getClass(buddySuite);
			if(Object.prototype.hasOwnProperty.call(haxe_rtti_Meta.getType(tmp),"include")) {
				return true;
			}
	...
	,runTestFuncs: function(funcs,done) {
		...
		AsyncTools.aEachSeries(asyncQ,function(f1,done1) {
			f1(function() {
				done1();
			});
		},done);
	...
	,isSync: function(funcs) {
		var tmp = $iterator(funcs)();
		while(tmp.hasNext()) if(tmp.next()[1] == 0) {
			return false;
		}
		return true;
	}
	,mapTestSpec: function(buddySuite,testSuite,beforeEachStack,afterEachStack,testSpec,done) {
		...
		switch(testSpec[1]) {
		case 0:
			var result = this.mapTestSuite(buddySuite,testSpec[2],beforeEachStack,afterEachStack,function(err1,newSuite) {
		...
		case 1:
			...
			var checkUtestResults = function() {
				...
				while(_g_head != null) {
					...
					case 0:
						break;
					case 1:
						var tmp = buddy_SuitesRunner.posInfosToStack(val[3]);
						reportFailure(val[2],tmp);
						break;
					case 2:
						reportFailure(val[2],val[3]);
						break;
					case 3:
						reportFailure(val[2],val[3]);
						break;
					...
					case 6:
						...
						break;
					case 7:
						spec.traces.push(val[2]);
						break;
					}
				}
			};
			if(!returnSync && buddySuite.timeoutMs > 0) {
				buddy_tools_AsyncTools.wait(buddySuite.timeoutMs).catchError(function(e) {
			...
			buddySuite.fail = function(err3,p2) {
				...
				var tmp2 = buddy_SuitesRunner.posInfosToStack(p2);
				reportFailure(err3,tmp2);
				var tmp3 = specCompleted(buddy_SpecStatus.Failed);
				setSyncResult(tmp3);
			};
			buddySuite.pending = function(message1,p3) {
				spec.traces.push(p3.fileName + ":" + p3.lineNumber + (message1 != null?": " + message1:""));
				var tmp4 = specCompleted(buddy_SpecStatus.Pending);
				setSyncResult(tmp4);
			};
			this.runTestFuncs(beforeEach,function(err4) {
				...
				(function(func,done1) {
					...
					checkUtestResults();
					if(err5 != null) {
						var tmp5 = haxe_CallStack.exceptionStack();
						reportFailure(err5,tmp5);
						var tmp6 = specCompleted(buddy_SpecStatus.Failed);
						setSyncResult(tmp6);
					} else {
						var tmp7 = specCompleted(buddy_SpecStatus.Passed);
						setSyncResult(tmp7);
					}
				});
			});
	...
	,done: function(suites,status) {
		...
		printTests = function(s1,indentLevel) {
			var print = function(str,color) {
				...
				_gthis.println(_gthis.strCol(color) + StringTools.lpad(str," ",str.length + (Math.max(0,indentLevel * 2) | 0)) + _gthis.strCol(39));
			};
			...
			if(s1.error != null) {
				print("ERROR: " + Std.string(s1.error),31);
				printStack("  ",s1.stack);
				return;
			}
			var _g4 = 0;
		...
		this.println(this.strCol(totalColor) + ("" + total + " specs, " + failures + " failures, ") + this.strCol(pending > 0?33:totalColor) + ("" + pending + " pending") + this.strCol(39));
...
mustache_Parser.nestTokens = function(tokens) {
	...
	while(_g < tokens.length) {
		...
		switch(token.type[1]) {
		case 3:
			sections.pop().sectionEndIndex = token.startIndex;
